...
String name;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       final String username="algoxentechnologies@gmail.com";
		final String password="algoxen123technologies";
		...
		try{
			...
			out.println("<script type=\"text/javascript\">");
                        ...
                        out.println("location='MailSender.jsp';");
                        out.println("</script>");
		...
		{
                    if(to==""){
                    request.setAttribute("errMsg", "Enter candidate's email");
                    request.setAttribute("foreignkey",foreignkey);
                    RequestDispatcher d=request.getRequestDispatcher("MailSender.jsp");
