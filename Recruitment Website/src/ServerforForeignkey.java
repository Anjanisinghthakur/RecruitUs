 ...
 * @author hp
 */
@WebServlet(urlPatterns = {"/ServerforForeignkey"})
public class ServerforForeignkey extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      //  request.setAttribute("email",email);
        ...
        RequestDispatcher rd=request.getRequestDispatcher(nameofjsppage);
